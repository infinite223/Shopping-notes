...
const NewNoteScreen = ({}) => {
  ...
  return (
    <SafeAreaView style={[tw`p-5 h-full bg-white`, {flex:1}]}>
      ...
      <TouchableOpacity onPress={()=>(createNote(title, products), navigation.navigate("HomeScreen"))} style={[tw`bg-green-600 p-1 pl-5 pr-5 rounded-full flex-row items-center`, { zIndex: 1,  position:"absolute", right:20, bottom:20}]}>
